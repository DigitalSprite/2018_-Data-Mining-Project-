...
def get_count_data():
    ...
    for vipno, temp_data in data.groupby('vipno'):
        temp_data = temp_data[temp_data['time'] < 5].sort_values(by='time')
        temp_count = [vipno, sum(temp_data.loc[:, 'qty'])]
        temp_amount = [vipno, sum(temp_data.loc[:, 'amt'])]
        for month in range(2, 5, 1):
    ...
    data_u.to_csv('data/type1/count/data_u.csv', index=False)
    ...
    data_b.to_csv('data/type1/count/data_b.csv', index=False)
    ...
    data_c.to_csv('data/type1/count/data_c.csv', index=False)
    ...
    data_i.to_csv('data/type1/count/data_i.csv', index=False)
    ...
    data_u_b.to_csv('data/type1/count/data_u_b.csv', index=False)
    ...
    data_u_c.to_csv('data/type1/count/data_u_c.csv', index=False)
    ...
    data_u_i.to_csv('data/type1/count/data_u_i.csv', index=False)
    ...
    data_b_c.to_csv('data/type1/count/data_b_c.csv', index=False)
...
def get_diversity_data():
    ...
    data_u_i = pd.DataFrame(count_i, columns=['u', 'u_i_count_unique_all', 'u_i_count_unique_2', 'u_i_count_unique_3',
                                              'u_i_count_unique_4'])
    data_u_i.to_csv('data/type1/diversity/data_u_i.csv', index=False)
    ...
    data_u_b = pd.DataFrame(count_b, columns=['u', 'u_b_count_unique_all', 'u_b_count_unique_2', 'u_b_count_unique_3',
                                              'u_b_count_unique_4'])
    data_u_b.to_csv('data/type1/diversity/data_u_b.csv', index=False)
    ...
    data_u_c = pd.DataFrame(count_c, columns=['u', 'u_c_count_unique_all', 'u_c_count_unique_2', 'u_c_count_unique_3',
                                              'u_c_count_unique_4'])
    data_u_c.to_csv('data/type1/diversity/data_u_c.csv', index=False)
    ...
    data_b_i.to_csv('data/type1/diversity/data_b_i.csv', index=False)
    ...
    data_c_i.to_csv('data/type1/diversity/data_c_i.csv', index=False)
...
def get_penetration_data():
    ...
    data_b.to_csv('data/type1/penetration/data_b.csv', index=False)
    ...
    data_c.to_csv('data/type1/penetration/data_c.csv', index=False)
    ...
    data_i.to_csv('data/type1/penetration/data_i.csv', index=False)
    print('create penetration grouped by category successfully')
