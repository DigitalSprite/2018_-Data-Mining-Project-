...
def get_month_agg_count():
    ...
    data = pd.read_csv('predict/type1/count/data_u.csv', dtype={'u': np.str})
    count = []
    amount = []
    ...
    data_agg_count_u.to_csv('predict/type2/month_agg/count/data_u.csv', index=False)
    print('create data_agg_count_u grouped by vipno successfully')
    print('\n##################################################')
    print('create data_agg_count_u grouped by bndno...')
    data = pd.read_csv('predict/type1/count/data_b.csv')
    count = []
    amount = []
    for index, row in data.iterrows():
        # 计算 count
    ...
    data_agg_count_b.to_csv('predict/type2/month_agg/count/data_b.csv', index=False)
    ...
    data_agg_count_c.to_csv('predict/type2/month_agg/count/data_c.csv', index=False)
    print('create data_agg_count_c grouped by dptno successfully')
    print('\n##################################################')
    print('create data_agg_count_i grouped by pluno...')
    data = pd.read_csv('predict/type1/count/data_i.csv')
    count = []
    amount = []
    for index, row in data.iterrows():
        # 计算 count
    ...
    data_agg_count_i.to_csv('predict/type2/month_agg/count/data_i.csv', index=False)
    print('create data_agg_count_i grouped by pluno successfully')
    print('\n##################################################')
    print('create data_agg_count_u_b grouped by vipno and bndno...')
    data = pd.read_csv('predict/type1/count/data_u_b.csv', dtype={'u': np.str})
    count = []
    amount = []
    for index, row in data.iterrows():
        # 计算 count
    ...
    data_agg_count_u_b.to_csv('predict/type2/month_agg/count/data_u_b.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/count/data_u_c.csv', dtype={'u': np.str})
    count = []
    amount = []
    for index, row in data.iterrows():
        # 计算 count
    ...
    data_agg_count_u_c = pd.DataFrame(new_data, columns=['u', 'c', 'u_c_agg_count_max', 'u_c_agg_count_median',
                                                         ...
                                                         'u_c_agg_amount_std'])
    data_agg_count_u_c.to_csv('predict/type2/month_agg/count/data_u_c.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/count/data_u_i.csv', dtype={'u': np.str})
    count = []
    amount = []
    for index, row in data.iterrows():
        # 计算 count
    ...
    data_agg_count_u_i.to_csv('predict/type2/month_agg/count/data_u_i.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/count/data_b_c.csv')
    count = []
    amount = []
    for index, row in data.iterrows():
        # 计算 count
    ...
    data_agg_count_b_c.to_csv('predict/type2/month_agg/count/data_b_c.csv')
...
def get_month_agg_diversity():
    ...
    data = pd.read_csv('predict/type1/diversity/data_u_i.csv', dtype={'u': np.str})
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['u']]
    ...
    new_data.to_csv('predict/type2/month_agg/diversity/data_u_i.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/diversity/data_u_b.csv', dtype={'u': np.str})
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['u']]
    ...
    new_data.to_csv('predict/type2/month_agg/diversity/data_u_b.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/diversity/data_u_c.csv', dtype={'u': np.str})
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['u']]
    ...
    new_data.to_csv('predict/type2/month_agg/diversity/data_u_c.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/diversity/data_b_i.csv')
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['b']]
    ...
    new_data.to_csv('predict/type2/month_agg/diversity/data_b_i.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/diversity/data_c_i.csv')
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['c']]
    ...
    new_data.to_csv('predict/type2/month_agg/diversity/data_c_i.csv', index=False)
...
def get_month_agg_penetration():
    ...
    data = pd.read_csv('predict/type1/penetration/data_b.csv')
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['b']]
    ...
    new_data.to_csv('predict/type2/month_agg/penetration/data_b.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/penetration/data_c.csv')
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['c']]
    ...
    new_data.to_csv('predict/type2/month_agg/penetration/data_c.csv', index=False)
    ...
    data = pd.read_csv('predict/type1/penetration/data_i.csv')
    count = []
    for index, row in data.iterrows():
        # 计算 count
        temp_count = [row.loc['i']]
    ...
    new_data.to_csv('predict/type2/month_agg/penetration/data_i.csv', index=False)
...
def get_user_agg():
    ...
    new_data.to_csv('predict/type2/user_agg/user_agg_b.csv', index=False)
    ...
    new_data.to_csv('predict/type2/user_agg/user_agg_c.csv', index=False)
    ...
    new_data.to_csv('predict/type2/user_agg/user_agg_i.csv', index=False)
...
def get_multiple_agg():
    ...
    new_data.to_csv('predict/type2/brand_agg.csv', index=False)
    ...
    new_data.to_csv('predict/type2/category_agg.csv', index=False)
    ...
    new_data.to_csv('predict/type2/item_agg.csv', index=False)
